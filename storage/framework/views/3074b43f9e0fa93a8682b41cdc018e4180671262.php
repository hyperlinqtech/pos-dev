            ...
            <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <ul class="nav nav-sm flex-column">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-products"
                                                class="nav-link"><?php echo app('translator')->get('translation.products'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-add-product"
                                                class="nav-link"><?php echo app('translator')->get('translation.create-product'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-orders"
                                                class="nav-link"><?php echo app('translator')->get('translation.orders'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-order-details"
                                                class="nav-link"><?php echo app('translator')->get('translation.order-details'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-customers"
                                                class="nav-link"><?php echo app('translator')->get('translation.customers'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-cart"
                                                class="nav-link"><?php echo app('translator')->get('translation.shopping-cart'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-checkout"
                                                class="nav-link"><?php echo app('translator')->get('translation.checkout'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-ecommerce-sellers"
                                                class="nav-link"><?php echo app('translator')->get('translation.sellers'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarProjects" class="nav-link" data-bs-toggle="collapse"
                                    role="button" aria-expanded="false"
                                    aria-controls="sidebarProjects"><?php echo app('translator')->get('translation.projects'); ?>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-projects-list"
                                                class="nav-link"><?php echo app('translator')->get('translation.list'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-projects-overview"
                                                class="nav-link"><?php echo app('translator')->get('translation.overview'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-projects-create"
                                                class="nav-link"><?php echo app('translator')->get('translation.create-project'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-tasks-kanban"
                                                class="nav-link"><?php echo app('translator')->get('translation.kanbanboard'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-tasks-details"
                                                class="nav-link"><?php echo app('translator')->get('translation.task-details'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-crm-contacts"
                                                class="nav-link"><?php echo app('translator')->get('translation.contacts'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-crm-companies"
                                                class="nav-link"><?php echo app('translator')->get('translation.companies'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-crypto-transactions"
                                                class="nav-link"><?php echo app('translator')->get('translation.transactions'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-crypto-buy-sell"
                                                class="nav-link"><?php echo app('translator')->get('translation.buy-sell'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-crypto-wallet"
                                                class="nav-link"><?php echo app('translator')->get('translation.my-wallet'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-crypto-ico"
                                                class="nav-link"><?php echo app('translator')->get('translation.ico-list'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-crypto-kyc"
                                                class="nav-link"><?php echo app('translator')->get('translation.kyc-application'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarInvoices" class="nav-link" data-bs-toggle="collapse"
                                    role="button" aria-expanded="false" aria-controls="sidebarInvoices"> Invoices
                                </a>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-invoices-details"
                                                class="nav-link"><?php echo app('translator')->get('translation.details'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="apps-invoices-create"
                                                class="nav-link"><?php echo app('translator')->get('translation.create-invoice'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarTickets" class="nav-link" data-bs-toggle="collapse"
                                    role="button" aria-expanded="false" aria-controls="sidebarTickets"> Support Tickets
                                </a>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-tickets-details"
                                                class="nav-link"><?php echo app('translator')->get('translation.ticket-details'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="layouts-horizontal" class="nav-link"
                                    target="_blank"><?php echo app('translator')->get('translation.horizontal'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="layouts-detached" class="nav-link"
                                    target="_blank"><?php echo app('translator')->get('translation.detached'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="layouts-two-column" class="nav-link"
                                    target="_blank"><?php echo app('translator')->get('translation.two-column'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <ul class="nav nav-sm flex-column">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-signin-basic"
                                                class="nav-link"><?php echo app('translator')->get('translation.basic'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-signin-cover"
                                                class="nav-link"><?php echo app('translator')->get('translation.cover'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarSignUp">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-signup-basic"
                                                class="nav-link"><?php echo app('translator')->get('translation.basic'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-signup-cover"
                                                class="nav-link"><?php echo app('translator')->get('translation.cover'); ?>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarLogout">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-logout-basic"
                                                class="nav-link"><?php echo app('translator')->get('translation.basic'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-logout-cover"
                                                class="nav-link"><?php echo app('translator')->get('translation.cover'); ?>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarTwoStep">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-twostep-basic"
                                                class="nav-link"><?php echo app('translator')->get('translation.basic'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-twostep-cover"
                                                class="nav-link"><?php echo app('translator')->get('translation.cover'); ?>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarErrors">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-404-basic"
                                                class="nav-link"><?php echo app('translator')->get('translation.404-basic'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-404-cover"
                                                class="nav-link"><?php echo app('translator')->get('translation.404-cover'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarProfile" class="nav-link" data-bs-toggle="collapse"
                                    role="button" aria-expanded="false"
                                    aria-controls="sidebarProfile"><?php echo app('translator')->get('translation.profile'); ?>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="pages-profile"
                                                class="nav-link"><?php echo app('translator')->get('translation.simple-page'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="pages-profile-settings"
                                                class="nav-link"><?php echo app('translator')->get('translation.settings'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="pages-search-results"
                                    class="nav-link"><?php echo app('translator')->get('translation.search-results'); ?>
                                </a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="ui-accordions"
                                            class="nav-link"><?php echo app('translator')->get('translation.accordion-collapse'); ?>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="ui-placeholders"
                                            class="nav-link"><?php echo app('translator')->get('translation.placeholders'); ?>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="ui-notifications"
                                            class="nav-link"><?php echo app('translator')->get('translation.notifications'); ?>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="ui-embed-video"
                                            class="nav-link"><?php echo app('translator')->get('translation.embed-video'); ?>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="advance-ui-sweetalerts"
                                    class="nav-link"><?php echo app('translator')->get('translation.sweet-alerts'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="forms-checkboxs-radios"
                                    class="nav-link"><?php echo app('translator')->get('translation.checkboxs-radios'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-column"
                                                class="nav-link"><?php echo app('translator')->get('translation.column'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-mixed"
                                                class="nav-link"><?php echo app('translator')->get('translation.mixed'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-timeline"
                                                class="nav-link"><?php echo app('translator')->get('translation.timeline'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-candlestick"
                                                class="nav-link"><?php echo app('translator')->get('translation.candlstick'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-boxplot"
                                                class="nav-link"><?php echo app('translator')->get('translation.boxplot'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-bubble"
                                                class="nav-link"><?php echo app('translator')->get('translation.bubble'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-scatter"
                                                class="nav-link"><?php echo app('translator')->get('translation.scatter'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-heatmap"
                                                class="nav-link"><?php echo app('translator')->get('translation.heatmap'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-treemap"
                                                class="nav-link"><?php echo app('translator')->get('translation.treemap'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-radialbar"
                                                class="nav-link"><?php echo app('translator')->get('translation.radialbar'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-radar"
                                                class="nav-link"><?php echo app('translator')->get('translation.radar'); ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-polar"
                                                class="nav-link"><?php echo app('translator')->get('translation.polar-area'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-materialdesign"
                                    class="nav-link"><?php echo app('translator')->get('translation.material-design'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse menu-dropdown" id="sidebarCrm">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <a href="#"
                                                            class="nav-link"><?php echo app('translator')->get('translation.level-3.1'); ?>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="#"
                                                            class="nav-link"><?php echo app('translator')->get('translation.level-3.2'); ?>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
...
<?php /**PATH E:\Velzon_v1.5.0\Laravel\material\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>